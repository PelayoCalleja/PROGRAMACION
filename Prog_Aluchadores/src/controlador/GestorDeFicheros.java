...
public class GestorDeFicheros {
    ...
    public void leer() {
        ...
        try {
            ...
            File nomFile = new File("Luchadores.csv");
            ...
            while ((linea = br.readLine()) != null) { //nt
                objToken = new TokenizarLuchador(linea); // cambiar por n objeto del mismo tipo del de la línea 35
                Luchador luchador = objToken.tokenizar(); // cambiar por el objeto de lógica que represente cada fila
                // Esta línea es para comprobar si va bien, si la comento funciona igual
                System.out.println("Alumno" + luchador.toString());
    ...
    public ArrayList<Luchador> cargarEnModelo() {

        ArrayList<Luchador> lista = new ArrayList<>();
        ...
        try {
            ...
            while ((linea = br.readLine()) != null) { //nt
                objToken = new TokenizarLuchador(linea); // cambiar por n objeto del mismo tipo del de la línea 35
                Luchador luchador = objToken.tokenizar(); // cambiar por el objeto de lógica que represente cada fila
                lista.add(luchador); // cambiar el nombre de la variable por la qe puse en la línea anterior
                // Esta línea es para comprobar si va bien, si la comento funciona igual
